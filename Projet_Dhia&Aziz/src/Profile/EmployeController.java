...
public class EmployeController implements Initializable {
    ...
    private employe_maintenance employe_maintenance ;
    ...
    public void setEmp(employe_maintenance p) {
       this.employe_maintenance=p;
    ...
    FXMLLoader loader = new FXMLLoader(getClass().getResource("/CRUD/CRUDM.fxml"));
